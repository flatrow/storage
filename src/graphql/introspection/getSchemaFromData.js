 ...
 * // type Query {
 * //     Post(id: ID!): Post
 * //     allPosts(page: Int, take: Int, sortField: String, sortOrder: String, filter: PostFilter, distinct: String): [Post]
 * //     User(id: ID!): User
 * //     allUsers(page: Int, take: Int, sortField: String, sortOrder: String, filter: UserFilter, distinct: String): [User]
 * // }
 * //
 * // type Mutation {
...
export default (data) => {
     ...
     *
     * @example
     * If the `post` key contains a 'userId' field, then
